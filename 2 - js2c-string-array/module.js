...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'module.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'module.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'module.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "module.js.mem" : null;
...
var real__coolbeans = asm["_coolbeans"]; asm["_coolbeans"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__coolbeans.apply(null, arguments);
};
...
var _coolbeans = Module["_coolbeans"] = function() { return Module["asm"]["_coolbeans"].apply(null, arguments) };
